      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable){
            ...
            var popUpTitle = win.title;
            if (popUpTitle == undefined){
              popUpTitle = "选择颜色";
            }

            picker_ = $('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="' + popUpTitle + '">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
            $($this).append(picker_);
          }
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            show =
              function()
              {
                ...
                var attachIFrame = function()
                  {
                    ...
                    container.before('<iframe class="jPickerBgiFrame" />');
                ...
                if (settings.window.showCallback){
                  settings.window.showCallback(this);
                }
              },
            hide =
              function()
              {
                ...
                if (settings.window.hideCallback){
                  settings.window.hideCallback();
                }
              },
            initialize =
              function()
              {
                var win = settings.window,
                    popup = win.expandable ? $($this).find('.Container:first') : null;
                ...
                if (win.expandable)
                {
                  ...
                  container.mousedown(
					...
					var left =  win.position.x == 'left' ? (popup.offset().left - 530 - (win.position.y == 'center' ? 25 : 0)) + 'px' :
                ...
                if (win.expandable)
                {
                  ...
                  /*
                  if (win.parent){
                    var zIndex = $(win.parent).css("z-index");
                    picker_.find("span.Container").css("z-index", zIndex + 3);
                    picker_.find("table.jPicker").css("z-index", zIndex + 4);
                  }
                  */
                }
                else show.call($this);
