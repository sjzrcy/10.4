...
function init() {
	...
	if (action == "update") {
		...
		{
			formObj.elements['targetlist'].checked=true;	
		}
		else
		{
			formObj.elements['targetlist'].checked=false;	
		}
...
function setAllAttribs(elm) {
	...
	var target = getCheckValue(formObj, 'targetlist');
...
function getCheckValue(form_obj,field_name)
{
...
function getTargetListHTML(elm_id, target_form_element) {
	...
	html += '<input id="targetlist" name="targetlist" value="_blank" type="checkbox"/>';
	html += tinyMCEPopup.getLang('advlink_dlg.target_blank')
